export declare const templateChoices: readonly ["reactjs_ts_webpack_react-router-dom_styled-components_babel", "simple-Html-Js-Css-Structure"];
...
export declare const questions: ({
    ...
    name: string;
    message: string;
    choices: readonly ["reactjs_ts_webpack_react-router-dom_styled-components_babel", "simple-Html-Js-Css-Structure"];
})[];
